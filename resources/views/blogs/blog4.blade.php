...
<head>
    ...
    <title>Fotografia z tigerem</title>
...
<body>
    ...
    <div class="gory">
        <h1>Fotografia z tigerem</h1>
    </div>
    <div class="posty">
        <h5>@foreach ($Blogs4 as $Blog4)
            {!! $Blog4['wpis'] !!}
        @endforeach</h5>
        <img src="{{ asset('images/darolew.png') }}" alt="Lew jest grozny jfdfhdf!!!!!" width="30%" height="30%">
    </div>
